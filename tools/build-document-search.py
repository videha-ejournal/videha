...
<body>
<header><h1>{html.escape(title)}</h1><p class="source"><strong>Publication:</strong> {pub.upper()} · <strong>Issue:</strong> {issue}{' · <strong>Version:</strong> '+str(version) if version else ''}<br><a href="{html.escape(source, quote=True)}">Open original PDF at Internet Archive</a></p><div class="videha-a11y-bar videha-ai-standalone" role="region" aria-label="पृष्ठ सुनबाक आ सहायक तकनीक नियंत्रण · Listen, translate and assistive technology" data-pagefind-ignore="all"><button type="button" id="videha-tts-toggle" class="videha-tts-btn" aria-pressed="false" aria-label="ई पृष्ठ सुनू · Listen to this page"><span class="videha-tts-ic" aria-hidden="true">🔊</span><span class="videha-tts-label">सुनू · Listen</span></button><button type="button" id="videha-tts-stop" class="videha-tts-btn videha-tts-stop" hidden aria-label="वाचन रोकू · Stop reading"><span class="videha-tts-ic" aria-hidden="true">⏹</span><span class="videha-tts-label">रोकू</span></button><span id="videha-tts-status" class="videha-sr-only" role="status" aria-live="polite"></span></div></header>
...
<script src="../assets/js/videha-tts.js?v=20260818-hostfix2"></script>
<script src="../assets/js/videha-translate.js?v=20260827" data-videha-translate-standalone></script>
<script src="../assets/js/videha-access.js?v=20260827"></script>
</body></html>'''
