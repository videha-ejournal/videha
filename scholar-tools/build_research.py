...
def write_index(articles,candidates):
    ...
    language_options="".join(f'<option value="{esc_attr(lang)}">{html.escape(lang)}</option>' for lang in languages)
